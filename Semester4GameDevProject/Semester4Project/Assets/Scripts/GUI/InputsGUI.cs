...
public class InputsGUI : MonoBehaviour {
	...
	void Start ()
    {
        InputsPanel = transform.Find("InputsPanel");
        ...
        {
            if(InputsPanel.GetChild(i).name == "ForwardKey")
            {
                InputsPanel.GetChild(i).GetComponentInChildren<Text>().text = GameManager.GM.forward.ToString();
            }
            else if (InputsPanel.GetChild(i).name == "BackwardKey")
            {
                InputsPanel.GetChild(i).GetComponentInChildren<Text>().text = GameManager.GM.backward.ToString();
            }
            else if (InputsPanel.GetChild(i).name == "LeftKey")
            {
                InputsPanel.GetChild(i).GetComponentInChildren<Text>().text = GameManager.GM.left.ToString();
            }
            else if (InputsPanel.GetChild(i).name == "RightKey")
            {
                InputsPanel.GetChild(i).GetComponentInChildren<Text>().text = GameManager.GM.right.ToString();
            }
            else if (InputsPanel.GetChild(i).name == "JumpKey")
            {
                InputsPanel.GetChild(i).GetComponentInChildren<Text>().text = GameManager.GM.jump.ToString();
            }
            else if (InputsPanel.GetChild(i).name == "DashKey")
            {
                InputsPanel.GetChild(i).GetComponentInChildren<Text>().text = GameManager.GM.dash.ToString();
            }
            else if (InputsPanel.GetChild(i).name == "CrouchKey")
            {
                InputsPanel.GetChild(i).GetComponentInChildren<Text>().text = GameManager.GM.crouch.ToString();
            }
            else if (InputsPanel.GetChild(i).name == "InteractKey")
            {
                InputsPanel.GetChild(i).GetComponentInChildren<Text>().text = GameManager.GM.interact.ToString();
            }
            else if (InputsPanel.GetChild(i).name == "InventoryKey")
            {
                InputsPanel.GetChild(i).GetComponentInChildren<Text>().text = GameManager.GM.inventory.ToString();
            }
            else if (InputsPanel.GetChild(i).name == "AttackKey")
            {
                InputsPanel.GetChild(i).GetComponentInChildren<Text>().text = GameManager.GM.attack.ToString();
            }
        }
    }
